...
patches = [
    ...
    (
        ...
        [
            ...
            ("SinterMWPFDecoder", "SinterMWPFRationalDecoder", 5),
            ("SinterHUFDecoder", "SinterHUFRationalDecoder", 1),
            ("SinterSingleHairDecoder", "SinterSingleHairRationalDecoder", 1),
            ("MwpfCompiledDecoder", "MwpfRationalCompiledDecoder", 5),
            ("SinterBPMWPFDecoder", "SinterBPMWPFRationalDecoder", 2),
            ("BPMWPFCompiledDecoder", "BPMWPFRationalCompiledDecoder", 3),
        ],
    ),
    (
